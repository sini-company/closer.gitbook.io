...
## 프로필 설정 <a id="profile-setting"></a>

### 계정 정보 관리 <a id="account-info"></a>

* 프로필 사진\(아바타\) / 이메일 / 비밀번호 / 이름 / 전화번호를 설정할 수 있습니다.

### 언어 설정 <a id="language"></a>
...
### 이메일 구독 설정 <a id="email-subscription"></a>

* CLOSER에서 발송하는 마케팅 및 정보 이메일 수신 여부를 설정할 수 있습니다.

### 계정 관리 <a id="account-setting"></a>

#### 계정 비활성화 <a id="disable-account"></a>
