...
* ⚠️ 카카오톡 오픈빌더에서의 상담원 호출 기능은 [**카카오톡채널** **1:1상담 연결 기능**](kakao.md#1-1)이 이용됩니다.  
...
* 카드 갯수 및 카드 버튼 갯수가 **메신저에서 지원하는 갯수를 넘는 경우 초과분은 제거되어 전송**됩니다.
  * 단, **상담톡**에서는 카드가 여러 장 존재하는 경우 **카드의 갯수만큼 단일 카드 메시지가 전송**됩니다. 이는 상담톡에서는 캐로셀\(=가로 스크롤 가능한 형태의 카드형 메시지\)이 지원되지 않기 때문입니다.
