...
**여러 페이지에 웹 채팅을 연동한 경우** 혹은 **기존 회원 정보와 연동**이 필요한 경우 등의 상황에서, 각 페이지별로 초기 진입 [파라미터](../chatbot/node/parameter.md)를 다르게 설정하면 챗봇 시나리오에서 해당 값을 구분할 수 있습니다. 
