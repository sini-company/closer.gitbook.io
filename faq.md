...
#### **Q. 웰컴 메시지가 나타나지 않아요!** <a id="q-openbuilder-welcome"></a>
...
### 카카오톡 상담톡 <a id="kakaotalk-bizmessage"></a>

#### Q. 상담톡이 무엇인가요? <a id="q-kakaotalk-bizmessage"></a>
...
#### Q. 다른 챗봇 솔루션 \(네이버 클라우드 플랫폼, Google DialogFlow 등\)에 CLOSER를 연동할 수 있나요?  <a id="q"></a>
...
#### Q. Chat 에서 상담계정 추가는 무엇인가요? <a id="q-chat-agent-seats"></a>
